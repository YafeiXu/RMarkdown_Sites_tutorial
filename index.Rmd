...
These commands navigate into your new repo, then make a new branch called `gh-pages` and enter it. This branch name is crucial so don't change it. It's what github looks for when deciding whether or not to host your site. 
